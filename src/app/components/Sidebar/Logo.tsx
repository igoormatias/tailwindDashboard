 ...
 export function Logo() {
  return (
    <strong className="flex mx-1 items-center gap-2 text-xl font-semibold text-zinc-600">
    <svg
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_19001_307"
          />
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
          ...
          <feBlend
            in2="effect1_dropShadow_19001_307"
            result="effect2_dropShadow_19001_307"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_19001_307"
            result="shape"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_19001_307"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect1_backgroundBlur_19001_307"
            result="shape"
          />
        </filter>
        <linearGradient
    ...
    <span className="text-zinc-800"> Portal Admin</span>
    </strong>
  )
}
